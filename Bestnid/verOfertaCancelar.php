...
<html lang="es">
	...
	<body>
		<?php 
			...
			//chequear que la oferta exista, que el dueño es el usuario logueado y que la subasta a la cual pertenece la oferta este activa o finalizada
				...
				<div class="col-md-9">
					...
					<div class="row well well-lg">
						...
						<div class="col-md-9">
							...
							<a class="btn btn-lg btn-danger" href='<?php echo "cancelarOfertaBD.php?idOferta=".$row["idOferta"]." "; ?>' >Confirmar</a>
